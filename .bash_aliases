...
alias rdb='rails db'
alias mt='reetest ; bundle exec rake --reduce-compat db:migrate:reset ; bundle exec rake --reduce-compat spec ; reedev'
alias rt='reetest ; bundle exec rake RAILS_ENV=test --reduce-compat spec > log/test.stdout.log ; reedev'
alias rq='reetest ; bundle exec rake --reduce-compat cucumber > log/cucumber.stdout.log ; reedev'
